...
export default function Form(){
    ...
    const onSubmit = (data) => {
        axios.post(`https://637f91cd5b1cc8d6f949a34c.mockapi.io/form`, data)
        ...
        <div className={style.form}>
            ...
            <div>
                ...
                {errors?.firstName?.type === "maxLength" &&(
                    <p>Имя не может содержать более 30 символов</p>
                )}
                ...
                {errors?.patronymic?.type === "maxLength" &&(
                    <p>Отчество не может содержать более 30 символов</p>
                )}
                ...
                {errors?.email?.type === "maxLength" &&(
                    <p>Email не может содержать более 100 символов</p>
                )}
